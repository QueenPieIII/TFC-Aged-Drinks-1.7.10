...
public class Config
{
    ...
    public static void init(File configFile)
    {
        ...
        for(TABAgedFluids fluid : TABAgedFluids.values())
        {
            ...
            int effectTime = config.get(Configuration.CATEGORY_GENERAL, name+"EffectTime", fluid.getEffectTime(), "This number represents the amout of ticks the given effect will last").getInt();
            int effectStrength = config.get(Configuration.CATEGORY_GENERAL, name+"EffectStrength", fluid.getEffectStrength()+1, "This number represents the strength of the given effect").getInt();
